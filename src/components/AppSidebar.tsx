  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: "Profissionais", icon: Stethoscope, iconName: "Stethoscope", path: "/configuracoes/profissionais" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { label: "Fluxo de Documentos", icon: FileText, iconName: "FileText", path: "/configuracoes/fluxo-documentos" },
        ],
      },
    ],
  },

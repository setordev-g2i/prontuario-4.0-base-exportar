...
import {
  fetchLogs,
  inactivateLog,
} from "@/services/fluxodocsLogs";
import type { FluxodocsLog } from "@/types/entities/Fluxodocs";
import {
  FluxodocsLogsModal,
  type FluxodocsLogsModalMode,
} from "./components/FluxodocsLogsModal";
...
export default function FluxodocsLogsPage() {
  ...
  const [data, setData] = useState<FluxodocsLog[]>([]);
  ...
  const [modalMode, setModalMode] = useState<FluxodocsLogsModalMode>("create");
  const [selected, setSelected] = useState<FluxodocsLog | null>(null);

  function openModal(mode: FluxodocsLogsModalMode, r: FluxodocsLog | null) {
    setModalMode(mode);
    setSelected(r);
    setModalOpen(true);
  }
  ...
  async function confirmInactivate() {
    ...
    try {
      await inactivateLog(inactivatingId);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Configurações &gt; Fluxo de Documentos &gt; Logs
          </p>
        </div>
